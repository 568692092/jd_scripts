...
FileLoon=$WorkDir/Loon/568692092_LoonTask.conf
FileQx=$WorkDir/QuantumultX/568692092_gallery.json
FileQxRe=$WorkDir/QuantumultX/568692092_cookies.conf
FileSurge=$WorkDir/Surge/568692092_Task.sgmodule.sgmodule
...
do
    ...
    if [[ -n $TaskName ]]; then
        ...
        grep -E "https://gitee\.com.+tag.+enabled" $file | perl -pe "{s|(.+\w)|\1\", \"addons\":\"https://gitee.com/568692092/jd_scripts/raw/master/QuantumultX/568692092_cookies.conf\"\},|; s|^|    \{\"config\":\"|}" >> $FileQx
