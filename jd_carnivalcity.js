...
[task_local]
#京东手机狂欢城
0 0-18/6 * * * https://gitee.com/568692092/jd_scripts/raw/master/jd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "0 0-18/6 * * *" script-path=https://gitee.com/568692092/jd_scripts/raw/master/jd_carnivalcity.js, tag=京东手机狂欢城

====================Surge================
京东手机狂欢城 = type=cron,cronexp=0 0-18/6 * * *,wake-system=1,timeout=3600,script-path=https://gitee.com/568692092/jd_scripts/raw/master/jd_carnivalcity.js

============小火箭=========
5G狂欢城 = type=cron,script-path=https://gitee.com/568692092/jd_scripts/raw/master/jd_carnivalcity.js, cronexpr="0 0,6,12,18 * * *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if ($.canHelp) {
        console.log(`\n\n如果有剩余助力机会，则给作者568692092以及随机码助力`)
        await doHelp();
      }
    }
  }
